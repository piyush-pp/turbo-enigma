...
import '@/index.css';
function DashboardLayout({ businessId }) {
...
function App() {
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(PublicHomePage, {}) }), _jsx(Route, { path: "/booking/:businessSlug", element: _jsx(PublicBookingPage, {}) }), _jsx(Route, { path: "/owner/login", element: _jsx(OwnerLoginPage, {}) }), _jsx(Route, { path: "/owner/:businessId/*", element: _jsx(OwnerProtectedRoute, { children: _jsx(OwnerDashboardPage, {}) }) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/signup", element: _jsx(SignupPage, {}) }), _jsx(Route, { path: "/dashboard/:businessId/*", element: _jsx(ProtectedRoute, { children: _jsx(DashboardLayout, { businessId: '' }) }) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }));
}
export default App;
